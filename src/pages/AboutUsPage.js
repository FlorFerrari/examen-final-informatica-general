...
const AboutUsPage  = () => {
    ...
    const info = [
        ...
        {
            title: null,
            text: 'Funcionamos como “sello discográfico”. Su objetivo es editar un disco por año en el que se incluya una canción de cada uno de los artistas. En febrero de este año salio, nuestro ultimo compilado, “Ficciones III”. La semilla de Amancay germinó ante la percepción de un vacío en la escena local, una necesidad de representación de un sonido que trascendía fronteras y géneros establecidos. Surgió así, como respuesta a una búsqueda de identidad, un lugar propio en el vasto universo de la música electrónica. ',
